...
<div class="container mt-5">
    ...
    <div class="row m-1">
        <!-- <div class="col-12"> -->
            <button class="btn btn-primary d-md-none float-end" id="toggleSidebar">
            Categories
    ...
    <div class="row mb-5">
        ...
        <div class="rounded mt-4 col-md-3 bg-danger sidebar-container">
                ...
                <div class="sidebar">
                <!-- <button id="closeSidebar" class="btn bg-black d-md-none text float-end"><i class="bi bi-x-lg"></i></button> -->
                <!-- Close Button -->
                ...
                <ul class="category-list">
                    <li class="category-item">
                        <a href="{{ route('web.blog') }}"
                            class="category-link {{ Request::is('blog') ? 'active' : '' }}">All</a>
                    </li>
